...
piklist('field', array(
  ...
  'label' => __('Tuesday blocks', 'piklist-demo'),
  'description' => __('Create Tuesday blocks.', 'piklist-demo'),
  'add_more' => true,
...
piklist('field', array(
  ...
  'label' => __('Wednesday blocks', 'piklist-demo'),
  'description' => __('Create Wednesday blocks.', 'piklist-demo'),
  'add_more' => true,
  'fields' => $repeatable_fields,
));
...
piklist('field', array(
  ...
  'label' => __('Thursday blocks', 'piklist-demo'),
  'description' => __('Create Thursday blocks.', 'piklist-demo'),
  'add_more' => true,
  'fields' => $repeatable_fields,
));
...
piklist('field', array(
  ...
  'label' => __('Friday blocks', 'piklist-demo'),
  'description' => __('Create Friday blocks.', 'piklist-demo'),
  'add_more' => true,
  'fields' => $repeatable_fields,
));
...
piklist('field', array(
  ...
  'label' => __('Saturday blocks', 'piklist-demo'),
  'description' => __('Create Saturday blocks.', 'piklist-demo'),
  'add_more' => true,
  'fields' => $repeatable_fields,
));